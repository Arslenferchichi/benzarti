...
<form name="frmUser" method="post" action="">
   <div class="message">
    ...
    <table border="0" cellpadding="10" cellspacing="1" width="500" align="center" class="tblLogin">
        ...
        <tr class="tableheader">
            <td align="left" ><input type="submit" name="submit" value="Submit" class="btnSubmit"></td>
            <td><button class="btnSubmit" ><a href="./AjouterUtilisateur.php" style="text-decoration: none;">sign in</a></button></td>
        </tr>
    </table>
</form>
</body>
